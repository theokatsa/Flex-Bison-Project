...
method_call:
    IDENTIFIER { setMethodName($1); } OPEN_PAREN argument_list CLOSE_PAREN SEMICOLON{
...
method_declaration:
    opt_modifier type IDENTIFIER { setIdentifierName($3); setMethodType(var_type); } OPEN_PAREN argument_list CLOSE_PAREN  OPEN_BRACE statements CLOSE_BRACE {
